...
gdf_error read_csv(csv_read_arg *args)
{
	...
	size_t	map_size = 0;
        ...
        mvfs_connect_option conn_opt_ = mvfs_connect_default_option; //to avoid warmup in mvfs_connect_mc which is very slow
...
//              map_data = mmap(0, map_size, PROT_READ, MAP_PRIVATE, fd, 0);
                ...
                start = clock();
#endif
                map_data = mvfs_mmap_mc(connection_, fd, 0, map_size);
